...
<<echo=FALSE, fig.height=7, fig.width=7, results="asis", out.width="0.65\\textwidth">>=
...
<<fig.align="center", fig.height = 5, out.width = "0.5\\textwidth", echo = FALSE>>=
...
<<R.options=list(width = 55), echo=FALSE>>=
summary(hept.pca)
@
