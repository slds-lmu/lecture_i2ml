...
\begin{itemize}
  ...
  \textbf{fully-connected} layers with all neurons linked to each other
  ...
  information with temporal dependencies $\rightarrow$ times series, text, audio
...
\begin{itemize}
  \item Network \textbf{depth} (i.e., number of layers)
