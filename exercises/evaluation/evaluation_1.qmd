...
notebook-view:
  - notebook: ex_eval_1_R.ipynb
    ...
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/evaluation/ex_eval_1_R.ipynb"
  - notebook: ex_eval_1_py.ipynb
    title: "Exercise sheet for Python"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/evaluation/ex_eval_1_py.ipynb"
  - notebook: sol_eval_1_R.ipynb
    title: "Solutions for R"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/evaluation/sol_eval_1_R.ipynb"
  - notebook: sol_eval_1_py.ipynb
    title: "Solutions for Python"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/evaluation/sol_eval_1_py.ipynb"
---
...
Explain importance of using test error and why choice of performance metric matters
:::
...
::: {.panel-tabset}
### R
{{< embed ex_eval_1_R.ipynb#1c echo=true >}}
### Python
{{< embed ex_eval_1_py.ipynb#1c echo=true >}}
:::
</details>
...
::: {.panel-tabset}
### R
{{< embed sol_eval_1_R.ipynb#1c echo=true >}}
### Python
{{< embed sol_eval_1_py.ipynb#eval-train echo=true >}}
{{< embed sol_eval_1_py.ipynb#eval-test echo=true >}}
{{< embed sol_eval_1_py.ipynb#eval-learn echo=true >}}
:::
...
::: {.callout-note title="Learning goals" icon=false}
1) Understand how strongy performance estimates can depend on data samples
2) Explain the bias-variance tradeoff of the GE estimator for repeated sampling across different train/test splits
:::
...
::: {.panel-tabset}
### R
{{< embed ex_eval_1_R.ipynb#2a echo=true >}}
### Python
{{< embed ex_eval_1_py.ipynb#2a echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed sol_eval_1_R.ipynb#2a echo=true >}}
### Python
{{< embed sol_eval_1_py.ipynb#2a1 echo=true >}}
{{< embed sol_eval_1_py.ipynb#2a2 echo=true >}}
{{< embed sol_eval_1_py.ipynb#2a3 echo=true >}}
:::
...
::: {.panel-tabset}
### R
{{< embed sol_eval_1_R.ipynb#2c1 echo=true >}}
{{< embed sol_eval_1_R.ipynb#2c2 echo=true >}}
{{< embed sol_eval_1_R.ipynb#2c3 echo=true >}}

### Python
{{< embed sol_eval_1_py.ipynb#2c1 echo=true >}}
{{< embed sol_eval_1_py.ipynb#2c2 echo=true >}}
:::
