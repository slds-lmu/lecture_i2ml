\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item[$x \leq 4.5$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 13.43$
    \item[$x \leq 8.5$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 0.13$
    \item[$x \leq 15$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 12.64$
  ...
  \begin{itemize}
    \item[$x \leq 0.3$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 19.14$
    \item[$x \leq 1.3$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 13.43$
    \item[$x \leq 2.1$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 0.13$
    \item[$x \leq 2.6$] $\mathcal{R}_{\text{emp}}(\mathcal{N}) = 12.64$
  \end{itemize}
