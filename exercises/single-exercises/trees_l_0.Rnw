...
$$MSE_{parent} = \frac{1}{5} \sum_{i=1}^5 (y_i - 4.7)^2 = 22.56 $$

Example calculation of sum of squares for split at $x \leq 1$: 
$$MSE_{children} = MSE_{left} + MSE_{right}  = 
\frac{1}{5}(1 - 1)^2 + \frac{4}{5}((1 - 5.625)^2 + (0.5 - 5.625)^2 + (10 - 5.625)^2 + (11 - 5.625)^2) = 19.1375 $$
The reduction in impurity is: 
$$MSE_{parent} - MSE_{children} = 22.56 - 19.14 = 3.42 $$
