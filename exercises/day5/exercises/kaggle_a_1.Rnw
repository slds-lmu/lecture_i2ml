...
Based on everything you learned in the last few days, make your own submission to kaggle for the Titanic survival challenge.
\begin{itemize}
  ...
  \item[c)] Tune your parameters using random search (see: \url{https://mlr.mlr-org.com/articles/tutorial/tune.html})
