Think of a practical use case of your daily work where you would like to apply machine learning methods. Summarize your answers in the digital whiteboard that is linked in the etherpad.
