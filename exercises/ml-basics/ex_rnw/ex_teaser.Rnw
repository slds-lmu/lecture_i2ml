...
\multicolumn{1}{ |c| }{0} & 57 & 52 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 37 & 154 &     \\ \cline{1-4}
\end{tabular} &
\begin{tabular}{cc|c|c|l}
\cline{3-4}
& & \multicolumn{2}{ c| }{Prediction} \\ \cline{3-4}
& & 0 & 1 \\ \cline{1-4}
\multicolumn{1}{ |c  }{\multirow{2}{*}{Truth} } &
\multicolumn{1}{ |c| }{0} & 100 & 9 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 6 & 185 &     \\ \cline{1-4}
\end{tabular} &
\begin{tabular}{cc|c|c|l}
\cline{3-4}
& & \multicolumn{2}{ c| }{Prediction} \\ \cline{3-4}
& & 0 & 1 \\ \cline{1-4}
\multicolumn{1}{ |c  }{\multirow{2}{*}{Truth} } &
\multicolumn{1}{ |c| }{0} & 98 & 11 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 15 & 176 &     \\ \cline{1-4}
\end{tabular} \\
\end{tabular}
\end{center}
