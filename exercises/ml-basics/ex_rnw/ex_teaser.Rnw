...
\multicolumn{1}{ |c| }{0} & 57 & 37 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 52 & 154 &     \\ \cline{1-4}
\end{tabular} &
\begin{tabular}{cc|c|c|l}
\cline{3-4}
& & \multicolumn{2}{ c| }{Truth} \\ \cline{3-4}
& & 0 & 1 \\ \cline{1-4}
\multicolumn{1}{ |c  }{\multirow{2}{*}{Prediction} } &
\multicolumn{1}{ |c| }{0} & 100 & 6 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 9 & 185 &     \\ \cline{1-4}
\end{tabular} &
\begin{tabular}{cc|c|c|l}
\cline{3-4}
& & \multicolumn{2}{ c| }{Truth} \\ \cline{3-4}
& & 0 & 1 \\ \cline{1-4}
\multicolumn{1}{ |c  }{\multirow{2}{*}{Prediction} } &
\multicolumn{1}{ |c| }{0} & 98 & 15 &     \\ \cline{2-4}
\multicolumn{1}{ |c  }{}                        &
\multicolumn{1}{ |c| }{1} & 11 & 176 &     \\ \cline{1-4}
\end{tabular} \\
\end{tabular}
\end{center}
