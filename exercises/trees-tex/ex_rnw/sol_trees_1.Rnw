\begin{enumerate} [a)]
  ...
  \begin{itemize}
    ...
    \item $x \leq 4.5$ ~~ $\Longrightarrow$ $\risk(\Np, 4.5) = 13.43$
    \item$x \leq 8.5$ ~~ $\Longrightarrow$ $\risk(\Np, 8.5) = 0.13$ 
    ~~ \textbf{optimal}
    \item$x \leq 15$ ~~~ $\Longrightarrow$ $\risk(\Np, 15) = 12.64$
  ...
  \begin{itemize}
    \item $\log x \leq 0.3$ ~~ $\Longrightarrow$ $\risk(\Np, 0.3) = 19.14$
    \item $\log x \leq 1.3$ ~~ $\Longrightarrow$ $\risk(\Np, 1.3) = 13.43$
    \item $\log x \leq 2.1$ ~~ $\Longrightarrow$ $\risk(\Np, 2.1) = 0.13$ 
    ~~ \textbf{optimal}
    \item $\log x \leq 2.6$ ~~ $\Longrightarrow$ $\risk(\Np, 2.6) = 12.64$
  \end{itemize}
