...
Now when we've seen that it's important to look beyond accuracy, and actually analyze the types of errors our models make, we introduce the confusion matrix and two important metrics: precision and recall.
