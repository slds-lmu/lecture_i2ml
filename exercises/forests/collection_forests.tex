...
\end{alltt}
\begin{verbatim}
## INFO  [14:46:08.495] [mlr3]  Applying learner 'classif.rpart' on task 'spirals' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [14:46:08.831] [mlr3]  Applying learner 'classif.ranger' on task 'spirals' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [14:46:10.609] [mlr3]  Applying learner 'classif.rpart' on task 'circle' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [14:46:10.706] [mlr3]  Applying learner 'classif.ranger' on task 'circle' (iter 1/1)
\end{verbatim}
\begin{alltt}
