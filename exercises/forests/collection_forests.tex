...
\end{alltt}
\begin{verbatim}
## INFO  [13:04:19.609] [mlr3]  Applying learner 'classif.rpart' on task 'spirals' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [13:04:19.879] [mlr3]  Applying learner 'classif.ranger' on task 'spirals' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [13:04:21.707] [mlr3]  Applying learner 'classif.rpart' on task 'circle' (iter 1/1)
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## INFO  [13:04:21.805] [mlr3]  Applying learner 'classif.ranger' on task 'circle' (iter 1/1)
\end{verbatim}
\begin{alltt}
