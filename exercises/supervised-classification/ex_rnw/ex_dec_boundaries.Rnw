...
Generate 1000 points from \texttt{cassini} using \texttt{R} or import \href{https://downgit.github.io/#/home?url=https://github.com/slds-lmu/lecture_i2ml/blob/master/exercises/data/cassini_data.csv}{\texttt{cassini\_data.csv}} in \texttt{Python}.\\
