...
c) ::: {.callout-tip icon=false title="Only for lecture group A"}
...
::: {.content-hidden when-profile="b"}
d) ::: {.callout-tip icon=false title="Only for lecture group A"}
   Using the result for the gradient, explain how to update the current parameter $\thetat$ in a step of gradient descent.
