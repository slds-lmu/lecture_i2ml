...
notebook-view:
  - notebook: ex_regression_R.ipynb
    ...
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/regression/ex_forests_R.ipynb"
  - notebook: ex_regression_py.ipynb
    title: "Exercise sheet for Python"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/regression/ex_forests_py.ipynb"
  - notebook: sol_regression_R.ipynb
    title: "Solutions for R"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/regression/sol_forests_R.ipynb"
  - notebook: sol_regression_py.ipynb
    title: "Solutions for Python"
    url: "https://github.com/slds-lmu/lecture_i2ml/blob/exercises/regression/sol_forests_py.ipynb"
---
...
2. Analyze and discuss learner flexibility
:::
...
\begin{align*}
  ...
  \alpha \cdot 2 \cdot \left( - \underbrace{\Xmat^\top \phantom{y}}_{
  ...
  \mat{\theta_1 \\ \theta_2 \\ \vdots \\ \theta_p}^{[t]} - \alpha 
  \cdot 2 \cdot \left( - \Xmat^\top \yv + \Xmat^\top \Xmat 
