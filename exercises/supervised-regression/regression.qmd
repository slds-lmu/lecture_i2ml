...
See how lecture concepts are translated to code
:::
...
::: {.callout-note title="Learning goals" icon=false}
See how choice of loss function affects behavior
:::
...
::: {.callout-note title="Learning goals" icon=false}
1) Apply HRO concept to polynomial regression
2) Discuss learner flexibility
:::
