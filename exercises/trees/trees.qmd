...
- $x \leq 1.5$
  ...
  - Risk left: $\rho_{\text{MSE}}(\Nl) = 0$
  - Risk right: $\rho_{\text{MSE}}(\Nr) = \tfrac{1}{4}((1 - 5.625)^2 + (0.5 - 5.625)^2 + (10 - 5.625)^2 + (11 - 5.625)^2)$
  - Aggregate risk: $\risk(\Np, 1.5) = \tfrac{|\Nl|}{|\Np|} \rho_{\text{MSE}}(\Nl) = \tfrac{1}{5} \cdot 0 + \tfrac{4}{5} \cdot 23.925 = 19.14$
...
***
Derive the optimal constant predictor for a node $\Np$ when minimizing the empirical risk under $L2$ loss and explain why this is equivalent to minimizing \enquote{variance impurity}.
