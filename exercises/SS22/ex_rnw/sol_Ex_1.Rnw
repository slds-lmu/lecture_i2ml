...
$$
%
For the latter we have seen in the lecture (optimizer of the empirical L2 risk) that
%
...
%		
	\end{align*}
% 
Note that we could have used the a similar substitution as in (a) here to derive $\fbayes.$
%
...
\end{align*}
%
If we consider as the the hypothesis space
%
