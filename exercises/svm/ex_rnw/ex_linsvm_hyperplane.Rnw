...
\begin{enumerate}
  ...
  \item
    Compute the euclidean distance of the non-margin-violating support vector(s) (i.e. support vector(s) that are located on the margin hyperplanes) to the decision boundary.
