...
Based on everything you learned in this course so far, do your best to get a good performance in the Titanic survival challenge.
\begin{itemize}
...
\textbf{Important:} Do not repeatedly evaluate your model on the test data. Instead use resampling techniques on the training data to compare models and tune hyperparameters.
