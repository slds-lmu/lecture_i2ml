...
\begin{enumerate}\bfseries
  ...
  \item[3)] Put these building blocks together so that they form the basic
...
\begin{enumerate}\bfseries
  \item[4)] Implement the 5-fold CV in the context of the tuning procedure
...
into the tuning framework from 3)!

\begin{enumerate}\bfseries
  \item[5)] Include the 5-fold CV in your tuning procedure. Make sure that at the end of
  your tuning procedure you receive the optimal value for k!
\end{enumerate}
