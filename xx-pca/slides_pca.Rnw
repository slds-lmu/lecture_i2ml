...
\begin{vbframe}{Suggested Literature}
  \begin{itemize}
...
<<echo=FALSE, fig.height=7, fig.width=7, out.width="0.65\\textwidth">>=
...
<<echo = FALSE, fig.height=7, fig.width=7, out.width="0.55\\textwidth">>=
a = pi/4
...
The \code{heptathlon} data set in the R package \enquote{HSAUR3} contains the competition results of 25 athletes in 7 disciplines for the Olympics held in Seoul in 1988.

<<message=FALSE, out.width="0.5\\textwidth", eval = 2, echo=TRUE>>=
...
\begin{vbframe}{Perform PCA using \code{princomp()}}
...
<<message=FALSE, fig.align="center", fig.height = 5, out.width = "0.8\\textwidth", echo=TRUE>>=
...
a1 %*% a1 # check constraint: is sum of squares equal to 1egin{vbframe}?
@
...
<<fig.align="center", fig.height = 5, out.width = "0.5\\textwidth", echo=TRUE>>=
...
<<R.options=list(width = 55), echo=TRUE>>=
summary(hept.pca)
@
...
<<fig.align="center", fig.height = 4, out.width = "0.7\\textwidth">>=
...
<<fig.align="center", fig.width = 8, fig.height = 6, out.width= "0.65\\textwidth", echo = FALSE>>=
