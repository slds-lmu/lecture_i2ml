...
pl1 = plot_coef_paths(path_l1$path, featnames, "Lasso / lambda") + theme_bw()
pl2 = plot_coef_paths(path_l2$path, featnames, "Ridge / lambda") + theme_bw()
pl3 = plot_cv_path(path_l1$cv_lam, "Lasso / lambda") + theme_bw()
pl4 = plot_cv_path(path_l2$cv_lam, "Ridge / lambda") + theme_bw()
