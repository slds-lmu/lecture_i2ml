...
$\thx$ with interpretable effect coefficients $\thetab$
...
\begin{itemize}
  ...
  $\pikx = \left. \exp(\thetab_k^\top \xv) \middle/ \sumkg \exp(\thetab_j^\top 
  \xv) \right.$
  \item Multi-class log-loss: $\Lpixy = - \sumjg \I_{\{y = k\}} \log(\pikx)$
