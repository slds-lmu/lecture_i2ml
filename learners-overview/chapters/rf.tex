...
\begin{itemize}
    \item Variance of the base learners can be further increased by \textbf{randomizing split points} instead of using the optimal one
...
\begin{itemize}
    ...
    \item While default values for the \textbf{number of split candidates} is often good, tuning it can still improve performance
