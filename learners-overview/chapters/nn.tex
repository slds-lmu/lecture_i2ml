...
\begin{columns}[onlytextwidth]
  \begin{column}{0.5\textwidth}
    ...
    \footnotesize
    \begin{itemize}
      \positem Applicable \textbf{complex, non-linear} problems
  ...
  \begin{column}{0.5\textwidth}
    ...
    \begin{itemize}
      ...
      \negitem High demand for \textbf{training data} required 
      \negitem Strong tendency to \textbf{overfit}
      \negitem Network architecture requiring lots of \textbf{tuning expertise} 
...
\begin{itemize}
  \item Control weight magnitudes with \textbf{weight decay} (L2 
  regularization)
