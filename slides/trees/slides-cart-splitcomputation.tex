...
\bibinput{slides-cart-splitcomputation}
...
\begin{frame}
\frametitle{Monotone feature transformations \citebutton{Strobl et al. (2008)}{https://doi.org/10.1186/1471-2105-9-307}}
...
\pagebreak
  ...
  \item The proofs are not trivial and can be found here:
    ...
    \item for 0-1 responses:
      ...
      \item Classification and Regression Trees \citeurl{breiman1984}
      %\item Ripley, 1996, Pattern Recognition and Neural Networks.
      \item Pattern Recognition and Neural Networks \citeurl{ripley1996}
      \end{itemize}
    \item for continuous responses:
      \begin{itemize}
      %\item Fisher, 1958, On grouping for maximum homogeneity.
      \item On Grouping for Maximum Homogeneity \citeurl{fisher1958}
      \end{itemize}
    \end{itemize}
...
\footnotesize
\nocite{*}
\bibliography{slides-cart-splitcomputation}
