...
\pagebreak
  ...
  \item The proofs are not trivial and can be found here:
    ...
    \item for 0-1 responses:
      ...
      \item Classification and Regression Trees \citepurl{breiman1984}
      %\item Ripley, 1996, Pattern Recognition and Neural Networks.
      \item Pattern Recognition and Neural Networks \citepurl{ripley1996}
      \end{itemize}
    \item for continuous responses:
      \begin{itemize}
      %\item Fisher, 1958, On grouping for maximum homogeneity.
      \item On Grouping for Maximum Homogeneity \citepurl{fisher1958}
      \end{itemize}
    \end{itemize}
