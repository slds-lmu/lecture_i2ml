...
Iterate over all features, and for each feature over all possible split points. Select the best split and divide data from the parent node into left and right child nodes.
\end{enumerate}
