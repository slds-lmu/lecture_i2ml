...
Greedy means we do an \textbf{exhaustive search}: All possible splits of $\Np$ on all possible points $t$ for all features $\xj$ are compared in terms of their empirical risk $\risk(\Np, j, t)$. 
