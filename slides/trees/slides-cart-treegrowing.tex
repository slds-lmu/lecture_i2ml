...
\item Search for a feature and split point that minimizes the empirical risk in the child nodes, which makes the label distribution less heterogenous.
\end{enumerate}
...
\item Additionally, MCE is only rarely used in practice
\end{itemize}


\begin{figure}
\includegraphics[width=0.77\textwidth]{figure/tree-classif-depth1.pdf}
\end{figure}
