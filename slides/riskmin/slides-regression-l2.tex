...
\newcommand{\learninggoals}{
  \item Know the risk minimizer of the L2-loss
\item Know the optimal constant model for the L2-loss
}
...
\item Residuals = Pseudo-residuals: \begin{footnotesize} $\tilde \eps = - \pd{0.5 (y-\fx)^2}{\fx} = y - \fx = r$\end{footnotesize}
\end{itemize}
