...
{\centering \includegraphics[width=0.7\textwidth]{images/reg_lm_plot} 
...
{\centering \includegraphics[width=0.6\textwidth]{images/reg_lm_plot_2} 
...
{\centering \includegraphics[width=\textwidth]{images/reg_lm_plot_31} 
...
{\centering \includegraphics[width=\textwidth]{images/reg_lm_plot_32} 
...
{\centering \includegraphics[width=\textwidth]{images/reg_lm_plot_33} 
...
{\centering \includegraphics[width=1.12\textwidth]{images/reg_lm_plot_34} 
...
{\centering \includegraphics[width=0.5\textwidth]{images/reg_lm_plot_35} 
...
{\centering \includegraphics[width=0.5\textwidth]{images/reg_lm_plot_36} 
...
{\centering \includegraphics[width=1.1\textwidth]{images/reg_lm_plot_37} 
...
{\centering \includegraphics[width=0.75\textwidth]{images/reg_lm_plot_38}
