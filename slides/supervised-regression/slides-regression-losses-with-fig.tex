...
{\centering \includegraphics[width=0.85\textwidth]{images/plot_quad_loss} 
}
...
{\centering \includegraphics[width=0.95\textwidth]{images/plot_abs_loss} 
...
{\centering \includegraphics[width=0.95\textwidth]{images/plot_abs_log_quad_loss} 
