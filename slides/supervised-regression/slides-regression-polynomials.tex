...
\begin{minipage}[b]{0.7\textwidth}
  ...
  \begin{itemize}
    ...
    \scriptsize
    \begin{align*}
      a \cdot f(x, \textcolor{orange}{\thetab}) + 
      b \cdot f(x, \textcolor{blue}{\thetab^\ast}) 
...
\begin{minipage}[b]{0.2\textwidth}
  ...
  \tiny \raggedleft
  \textcolor{orange}{$\thetab = (0.5, 0.4)^\top$} \\
  \textcolor{blue}{$\thetab = (1.0, 0.8)^\top$} \\
...
\begin{itemize}
    ...
    \textcolor{red}{TODO: plot w monomials as basis funs + plot w 
...
\includegraphics[width=0.9\textwidth]{figure/reg_poly_univ_2}
