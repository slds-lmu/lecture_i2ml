...
\footnotesize
$\min_{\thetab} \risket =
\min_{\thetab} \sumin \big(\underbrace{\yi - \thetab^\top \xi}_{=:
\epsilon_i} \big)^2
= \min_{\thetab} \| \underbrace{\yv - \Xmat \thetab}_{=: \bm{\epsilon}} \|^2_2$

\vfill

\begin{minipage}[t]{0.45\textwidth}
    \footnotesize Sum notation \tiny
    \begin{eqnarray*}
        % 0 &=& \frac{\partial \risket}{\partial \thetab} \\
        ...
        \thetab \sumin (\xi)^\top \xi &=& \sumin \xi \yi \\
        \thetab &=& \sumin \underbrace{
        \big( \underbrace{(\xi)^\top \xi}_{1 \times 1}  \big)^{-1}
        \underbrace{\phantom{y}\xi}_{p \times 1} \underbrace{\yi}_{1 \times 1} 
        }_{p \times 1}
...
\hfill
\begin{minipage}[t]{0.45\textwidth}
    \footnotesize Matrix notation \tiny
    \begin{eqnarray*}
        % 0 &=& \frac{\partial \risket}{\partial \thetab} \\
        0 &=& \frac{\partial \bm{\epsilon}^\top \bm{\epsilon}}{\partial \thetab} 
        ~~ \Big \rvert
        ~~ \text{chain rule} \\
        ...
        \thetab &=& \underbrace{
        \underbrace{(\Xmat^\top \Xmat)^{-1}}_{p \times p}
        \underbrace{\phantom{(} \Xmat^\top}_{p \times n} \underbrace{\yv}_{n 
        \times 1}}_{p \times 1}
    \end{eqnarray*}
\end{minipage}
