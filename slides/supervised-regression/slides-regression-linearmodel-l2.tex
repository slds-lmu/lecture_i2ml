...
\vfill
\includegraphics[width=0.4\textwidth]{figure/reg_lm_plot_interpreted} 
\hfill
...
\begin{itemize}
    ...
    \includegraphics[width=0.35\textwidth]{figure/reg_lm_sse}
...
\includegraphics[width=\textwidth]{figure/l2.pdf}
...
\begin{minipage}[c]{0.5\textwidth}
    ...
    \includegraphics[width=0.4\textwidth]{figure/reg_lm_sse_12.pdf} \\
    \includegraphics[width=0.4\textwidth]{figure/reg_lm_sse_13.pdf}
    \includegraphics[width=0.4\textwidth]{figure/reg_lm_sse_14.pdf}
    \vfill \vspace{0.5cm} \scriptsize
    \begin{tabular}{r|r|r}
        Intercept $\theta_0$ & Slope $\theta_1$ & SSE
        \\ \hline 1.80 & 0.30 & 16.86\\ \hline 1.00 & 0.10 & 24.29 
