...
{\centering \includegraphics[width=0.9\textwidth]{images/reg_pol_1} 
...
{\centering \includegraphics[width=0.9\textwidth]{images/reg_pol_2} 
...
{\centering \includegraphics[width=0.9\textwidth]{images/reg_pol_3} 
...
{\centering \includegraphics[width=0.9\textwidth]{images/reg_pol_4} 
...
{\centering \includegraphics[width=0.95\textwidth]{images/reg_pol_5} 
