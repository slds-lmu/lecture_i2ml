...
ggsave(file = "../figure/boosting_interaction_example_gam.png", plot = p, width = 6, height = 5)
...
ggsave(file = "../figure/boosting_interaction_example_ID2.png", plot = pint, width = 6, height = 5)
