# ------------------------------------------------------------------------------
# FIG: SPLIT-FINDING PLOTS
# ------------------------------------------------------------------------------

# Purpose: approximate split-finding algorithms
...
p <- grid.arrange(p1, p2, p3, layout_matrix = matrix(c(1,3,1,2), ncol = 2), nrow = 2)
ggsave("../figure/split_finding_1.png", plot = p, width = 6, height = 3.5)
...
p <- grid.arrange(p1, p2, p3, layout_matrix = matrix(c(1,3,1,2), ncol = 2), nrow = 2)
ggsave("../figure/split_finding_2.png", plot = p, width = 6, height = 3.5)
