...
\begin{minipage}[b]{0.45\textwidth}
  \includegraphics[width=\textwidth]{figure_man/adaboost_viz_mlr_1.png}\\
  \textbf{Iteration} $m$ = 1:
  \begin{itemize}
    \item $\text{err}^{[1]} = 0.3$
...
\begin{minipage}[c]{0.4\textwidth}
  \includegraphics[width = \textwidth]{figure_man/adaboost_viz_mlr_2.png}
\end{minipage}%
...
Increasing standard deviation to $sd = 0.3$ (all else being equal), AdaBoost 
overfits with increasing number of trees while the RF only saturates.
