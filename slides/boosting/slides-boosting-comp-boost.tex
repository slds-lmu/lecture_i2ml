...
\begin{minipage}[c]{0.4\textwidth}
  ...
  CWB model with linear base learners to predict the median home value.
  Using the \texttt{compboost} package with $M = 100$ iterations, we can 
...
\begin{itemize}
  ...
  linear and nonlinear ($P$-spline) base learners for the 13 features (all 
  numeric).
