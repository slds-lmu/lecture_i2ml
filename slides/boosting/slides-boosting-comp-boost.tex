...
with $M = 500$, to predict passengers' survival.
...
\begin{itemize}
  ...
  \item By iteration 500, the model has selected 8 out of 16 features, 4 of 
  which are categorical (concerning sex and passenger class).
  \item For the 4 numeric ones, the model always picks the nonlinear option. 
