...
considers residuals' sign, the corresponding base learners change more strongly 
with each iteration than $L2$'s approximation of ever smaller residuals.
...
residuals' sign and not their magnitude, resulting in a much smoother model.
