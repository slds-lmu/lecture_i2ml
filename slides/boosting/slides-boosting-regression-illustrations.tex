...
\newcommand{\learninggoals}{
  \item Comparison of different loss functions and
  \item Comparison of different base learners for regression
}
...
\only<1>{ 
\includegraphics[width=\textwidth]{figure/illustration_tdist_L2_1.png}
\includegraphics[width=\textwidth]{figure/illustration_tdist_L1_1.png}

\vfill
Iteration 1
}
\only<2>{ 
\includegraphics[width=\textwidth]{figure/illustration_tdist_L2_2.png}
\includegraphics[width=\textwidth]{figure/illustration_tdist_L1_2.png}

\vfill
Iteration 2
}
\only<3>{ 
\includegraphics[width=\textwidth]{figure/illustration_tdist_L2_3.png}
\includegraphics[width=\textwidth]{figure/illustration_tdist_L1_3.png}
