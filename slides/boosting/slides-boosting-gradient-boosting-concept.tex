...
\newcommand{\titlefigure}{figure_man/gradient-boosting.png}
...
\begin{figure}
  \includegraphics[width=0.47\textwidth]{figure_man/gradient-boosting.png}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.55\textwidth]{figure_man/pseudo-resi01.png}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.55\textwidth]{figure_man/pseudo-resi02.png}
\end{figure}
