...
\newcommand{\titlefigure}{figure/fig-gb-tree.png}
...
\column{5cm}
\begin{center}
  \includegraphics[width=1\textwidth]{figure_man/forward-stagewise-expl.png}
\end{center}
...
\begin{figure}
  \includegraphics[width=0.47\textwidth]{figure/fig-gb-tree.png}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.55\textwidth]{figure_man/fig-gb-concept-pseudo-resi-1.png}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.55\textwidth]{figure_man/fig-gb-concept-pseudo-resi-2.png}
\end{figure}
