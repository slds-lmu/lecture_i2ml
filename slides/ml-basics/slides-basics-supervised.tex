...
\newcommand{\titlefigure}{figure_man/what_is_a_model_web}
\newcommand{\learninggoals}{\item Understand the idea of supervised learning \item Know examples of supervised learning \item Understand the difference between the regression and classification task}
