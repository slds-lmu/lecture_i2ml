...
\lz
The kind of numerical technique that is reasonable for this problem strongly depends 
...
\]
\textbf{and} the Hessian $\frac{\partial^2}{\partial\thetav^2}\riske(\thetavh)$ is positive definite. While the neg. gradient points into the direction of fastest local decrease, the Hessian measures local curvature of $\riske$.
