...
\lz
Which kind numerical technique is reasonable for this problem strongly depends 
...
\begin{vbframe}{Gradient Descent}
    The simple idea of GD is to follow iteratively go from the current candidate $\thetab^{[t]}$ in the direction of the negative gradient, i.e., the direction of the steepest descent, with learning rate $\alpha$ to the next $\thetab^{[t+1]}$:
\[
