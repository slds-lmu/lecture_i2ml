...
\newcommand{\learninggoals}{\item Understand difference between targer and features \item Understand difference between labeled and unlabeled data \item Know concept of data generating process}
