...
\begin{itemize}
  ...
  % \item The data we deal with in machine learning usually consists of 
  % observations with different \textbf{features} and one or multiple 
  % \textbf{target} (also: \textbf{output} or \textbf{response}) variables.
  
  \item Imagine, for instance, you want to investigate how salary and workplace 
  conditions (\emph{features}) affect productivity of employees (\emph{target}). 
  Therefore, you collect data about their worked minutes per week 
  (productivity), how many people work in the same office as the employees in 
  question, and the employees' salary.
...
\begin{itemize}
  ...
  \item Usually we assume the data to be drawn i.i.d. from the joint 
