...
\newcommand{\titlefigure}{figure_man/learner_opt.jpg}
\newcommand{\learninggoals}{\item Understand the components of a learner \item Know the formalization of supervised learning \item Be able to apply the concept of a learner to a supervised learning task}
...
\begin{itemize}
  ...
  \begin{center}
    \includegraphics[width = 0.5\textwidth]{figure_man/learner_hyp_space.jpg} 
  \end{center}
  ...
  \begin{center}
    \includegraphics[width = 0.5\textwidth]{figure_man/learner_risk.jpg} 
  \end{center}
  ...
  \begin{center}
    \includegraphics[width = 0.5\textwidth]{figure_man/learner_opt.jpg} 
  \end{center}
