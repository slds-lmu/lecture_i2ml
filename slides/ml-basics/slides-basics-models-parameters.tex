...
\begin{columns}
  ...
  \begin{column}{0.33\textwidth}
    \begin{center}
      Exemplary setting
      \includegraphics[width=1.2\textwidth]{figure/hs-rbf-network-3d-1.pdf}
      % \begin{itemize}
      %   \item $a_1 = 0.4$ \\
      %   $a_2 = 0.2$ \\
      %   $a_3 = 0.4$
  ...
  \begin{column}{0.33\textwidth}
    \begin{center}
      Centers altered
      \includegraphics[width=1.2\textwidth]{figure/hs-rbf-network-3d-2.pdf}
    \end{center}
  \end{column}
  ...
  \begin{column}{0.33\textwidth}
    \begin{center}
      Weights altered
      \includegraphics[width=1.2\textwidth]{figure/hs-rbf-network-3d-3.pdf}
    \end{center}
  \end{column}
