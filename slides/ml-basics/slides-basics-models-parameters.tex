...
\begin{frame}{Example: RBF Network}
Radial basis function networks with Gaussian basis functions
$$
\Hspace = \bigg\{ f: \fx =  \sumik \textcolor{blue}{a_i} \rho ( \| \xv - \textcolor{orange}{\textbf{c}_i}  \|) 
\bigg\},
$$ 
\splitV[0.55]{
\begin{small}
...
{
\image[1]{figure_man/rbf_network.png} % https://www.researchgate.net/figure/Structure-of-Stacked-Autoencoders_fig2_325025951
}
\end{frame}
