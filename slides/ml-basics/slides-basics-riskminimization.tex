...
\begin{tabular}{ c | c | c || c }
 ...
 \hline
\(\displaystyle f_1 \)   & 2.00 & 3.00 & 194.62 \\
\(\displaystyle f_2 \)   & 3.00 & 2.00 & 127.12 \\  
\(\displaystyle f_3 \)   & 6.00 & -1.00 & 95.81 \\
\rowcolor{lightgray}
\(\displaystyle f_4 \)   & 1.00 & 1.50 & 57.96 \\  
\end{tabular}
\end{center}
...
\begin{center}
\begin{figure}[b]
%ml-basic-riskmin-2-risk.R second plot with green frame
