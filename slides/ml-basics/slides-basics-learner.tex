...
\end{itemize}
\imageC[0.7]{figure_man/data_table} % FIGURE SOURCE: https://docs.google.com/presentation/d/1qIWHJq-iZqfUsLLJD81Z9LhobGTIN3sDHTevnm5dxZ0/edit?usp=sharing
\end{frame}
...
\begin{frame}{Learner Definition}
In pseudo-code:
\begin{itemize}
