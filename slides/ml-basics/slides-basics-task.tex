...
\begin{center}
\includegraphics[width=0.9\textwidth]{figure/ml-basics-supervised-regression-task.png} 
\end{center}
}
{
...
\begin{center}
\includegraphics[width=0.9\textwidth]{figure/ml-basics-supervised-classif-task.png} 
\end{center}
}
