...
text(x = (t_x_i$x+t_x_i_n$x)/2 + 0.4, y = (t_x_i$y+t_x_i_n$y)/2 + 0.04, "$-\\alpha\\frac{\\partial}{\\partial\\theta}\\mathcal{R}_{\\textrm{emp}}(\\theta^{[0]})$", col="magenta", cex = 2)  
...
t_x_i_n <- trans3d(x_i_n[1],x_i_n[2],R(x_i_n),pmat)
arrows(x0 = t_x_i$x, y0=t_x_i$y, x1=t_x_i_n$x, y1=t_x_i_n$y, col="magenta", length = 0.15, lwd = 2)
text(x = (t_x_i$x+t_x_i_n$x)/2 + 0.4, y = (t_x_i$y+t_x_i_n$y)/2 + 0.04, "$-\\alpha\\frac{\\partial}{\\partial\\theta}\\mathcal{R}_{\\textrm{emp}}(\\theta^{[1]})$", col="magenta", cex = 2)  
