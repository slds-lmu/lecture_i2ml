...
\newcommand{\learninggoals}{
  ...
  \item Know that a hypothesis space is PAC learnable if it has finite VC dimension
}
...
\begin{itemize}
  ...
  \item It implies that our learner, given enough samples, always return an "approximately" correct function.
