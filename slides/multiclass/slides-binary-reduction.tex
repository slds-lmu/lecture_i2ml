...
\newcommand{\learninggoals}{
  \item \textcolor{blue}{Know how to model-agnostic reduce a mutliclass problem to a problem with multiple binary problems}
  \item \textcolor{blue}{One-vs-Rest}
  \item \textcolor{blue}{One-vs-One}
  \item \textcolor{blue}{Compare One-vs-One and One-vs-Rest}
}
