...
\end{itemizeS}
\textbf{For tabular data, deep learning can make sense in some cases but is interesting from a technical point of view.}
\begin{itemizeS}
\item Specialized, powerful hardware allows training of huge neural networks to push the state-of-the-art on difficult problems.
\item Without extensive tuning, models like random forests or gradient boosting will often outperform deep learning.
\item Deep learning can be valuable for tabular data with categorical features with many levels or complex feature interactions.
\item Technical challenges include overfitting, hyperparameter sensitivity, and interpretability.
\end{itemizeS}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\imageC[0.6][KRIZHEVSKY2009]{figure/classification.png}
