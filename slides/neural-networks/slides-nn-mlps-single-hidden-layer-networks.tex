...
\item The graphical representation of simple functions/models, like logistic regression, is useful because:
\item Individual neurons can be used as building blocks of more complex functions.
\item Networks of neurons can represent very complex hypothesis spaces.
\item Most importantly, it allows us to define appropriate hypothesis spaces to learn functions that are 
common in practice in a data-efficient way (see Lin, Tegmark et al. 2016).
\end{framei}
