...
% Unfortunately, more than k=3 (in total 5) of the observations in the table have the minimum distance of 0.100 (see last two rows of table)
% It is not the main issue here how to handle the case where more than k observations have minimal distance 
% Therefore, I would suggest to replace the last two observations by other observations
