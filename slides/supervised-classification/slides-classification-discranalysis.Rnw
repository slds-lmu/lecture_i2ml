...
&\propto& \pi_k \exp\left(- \frac{1}{2} x^T\Sigma^{-1}x - \frac{1}{2} \muk^T \Sigma^{-1} \muk + x^T \Sigma^{-1} \muk \right) \\
&=& \exp\left(\log \pi_k  - \frac{1}{2} \muk^T \Sigma^{-1} \muk + x^T \Sigma^{-1} \muk \right) \exp\left(- \frac{1}{2} x^T\Sigma^{-1}x\right) \\
&=& \exp\left(\theta_{0k} + x^T \theta_k\right) \exp\left(- \frac{1}{2} x^T\Sigma^{-1}x\right)
\end{eqnarray*}

by defining
$\theta_{0k} := \log \pi_k  - \frac{1}{2} \muk^T \Sigma^{-1} \muk$ and $\theta_k := \Sigma^{-1} \muk$.
...
$$
\pdfxyk = \frac{1}{(2\pi)^{\frac{p}{2}}|\Sigma_k|^{\frac{1}{2}}} \exp\left(-\frac{1}{2}(x - \muk)^T \Sigma_k^{-1} (x - \muk)\right)
$$
...
\begin{eqnarray*}
\pikx &\propto& \pi_k \cdot \pdfxyk \\
&=& \pi_k |\Sigma_k|^{-\frac{1}{2}}\exp(- \frac{1}{2} x^T\Sigma_k^{-1}x - \frac{1}{2} \muk^T \Sigma_k^{-1} \muk + x^T \Sigma_k^{-1} \muk )
\end{eqnarray*}

Taking the log of the above, we can define a discriminant function that is quadratic in $x$.

$$
\log \pi_k - \frac{1}{2} \log |\Sigma_k| - \frac{1}{2} x^T\Sigma_k^{-1}x - \frac{1}{2} \muk^T \Sigma_k^{-1} \muk + x^T \Sigma_k^{-1} \muk
$$
