...
\newcommand{\titlefigure}{figure/nutshell_classif_logistic_function}
...
\item Know distinction of discriminant and generative approach
...
\newpage
% FIXME: orphaned \item caused error, added linebreak afterwards
% \item
