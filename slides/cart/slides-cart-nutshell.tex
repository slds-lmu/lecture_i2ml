...
<<<<<<< HEAD
  \includegraphics[width = 0.9\textwidth]{slides/cart/figure_man/nutshell-cart-learning.png}
=======
  \includegraphics[width = 0.9\textwidth]{figure_man/nutshell-cart-learning.png}
>>>>>>> 97d9f381f16c02be0ed83947bf4857c2735f6ac0
\end{center}
\end{column}
\end{columns}
...
<<<<<<< HEAD
  \includegraphics[width = 0.9\textwidth]{slides/cart/figure_man/nutshell-cart-prediction.png}
=======
