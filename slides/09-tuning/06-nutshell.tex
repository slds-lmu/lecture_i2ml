...
\includegraphics[width=0.7\textwidth]{../10-nested-resampling/figure_man/train_valid_test.pdf}
\end{center}
...
\includegraphics[width = 0.6\textwidth]{../10-nested-resampling/figure_man/Nested_Resampling.png}
\end{center}
