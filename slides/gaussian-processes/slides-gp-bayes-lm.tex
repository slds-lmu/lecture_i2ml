...
\newcommand{\titlefigure}{figure/bayes_lm_posterior_5_3.pdf} % does not fit
...
\begin{figure}
  \includegraphics[width=0.6\textwidth]{figure/bayes_lm_example.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.5\textwidth]{figure/bayes_lm_prior_1.pdf}~\includegraphics[width=0.5\textwidth]{figure/bayes_lm_prior_2.pdf}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.5\textwidth]{figure/bayes_lm_posterior_\x_1.pdf}~  \includegraphics[width=0.5\textwidth]{figure/bayes_lm_posterior_\x_2.pdf}
\end{figure}
}
...
\foreach \x in{5, 10, 20} {
\begin{figure}
  \includegraphics[width=0.5\textwidth]{figure/bayes_lm_posterior_\x_3.pdf} \\
  \begin{footnotesize}
