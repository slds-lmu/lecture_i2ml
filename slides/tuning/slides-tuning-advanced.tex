...
\item Be able to explain the terms 'surrogate model' and 'expected improvement'
...
\item Continue with better fraction $:=1/\eta$ (often half, i.e., $\eta = 2$) of HPCs (w.r.t $\GEh{}$); 
with $\eta$ times budget
