...
\item We motivate the importance of tuning via a simulation example of 3 different algorithms: Decision Tree, k-NN and SVM. We use the dataset $mlbench.spiral$ and 10,000 testing points to calculate the measure AUC.  
