...
\item The solution is a \textbf{trimmed mean}:a (conditional) mean between two (conditional) quantiles. % (the location depends on the distribution and the value of $\delta$).  
