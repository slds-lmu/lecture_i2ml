...
\newcommand{\learninggoals}{
	\item Learn the correspondence of between a Laplacian error distributions and the L1 loss
	\item Learn that there is no error distribution for the Huber loss
	\item Learn the correpondence between Bernoulli-distributed targets and the Bernoulli loss 
