...
\subsection{0-1-loss}
\includepdf[pages=-]{../slides-pdf/slides-advriskmin-cassification-01.pdf}

\subsection{Bernoulli Loss}
\includepdf[pages=-]{../slides-pdf/slides-advriskmin-cassification-bernoulli.pdf}

\subsection{Brier Score}
\includepdf[pages=-]{../slides-pdf/slides-advriskmin-cassification-brier.pdf}

\subsection{Advanced Classification Losses}
\includepdf[pages=-]{../slides-pdf/slides-advriskmin-cassification-furtherlosses.pdf}
