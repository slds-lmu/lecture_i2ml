...
\item Learn the correspondence of between a Gaussian error distribution and the L2 loss
}
...
\includegraphics[width = 0.8\textwidth]{figure_man/residuals_plot_L2.pdf}
