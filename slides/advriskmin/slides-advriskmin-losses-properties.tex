...
\small
\textbf{Example: Lasso regression} \textcolor{blue}{@Bernd}
...
\begin{itemize}
  ...
  \item In particular, it holds for convex problems that local minima are also 
  global minima $\rightarrow$ a strictly convex function has at most 
...
\begin{minipage}[b]{0.45\textwidth}
  \includegraphics[width=\textwidth]{figure_man/convex-vs-nonconfex-landscape}
\end{minipage}%
...
%   
% \begin{itemize}
%   \item In practical terms convexity means that we do not need to worry to get 
%   stuck in local minima during risk minimization. 
