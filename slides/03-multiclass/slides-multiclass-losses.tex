...
\newcommand{\learninggoals}{
  \item \textcolor{blue}{Know what multiclass means and which types exists}
  \item \textcolor{blue}{0-1-Loss}
  \item \textcolor{blue}{MC Brier score}
  \item \textcolor{blue}{Logarithmic Loss}
}
...
\begin{footnotesize}
$$
    \pikx = \thetah_k = \frac{1}{n} \sumin \mathds{1}_{\{\yi = k\}},   
$$
\end{footnotesize}
 being the fraction of class-$k$ observations. \\
\vspace*{0.5cm}
