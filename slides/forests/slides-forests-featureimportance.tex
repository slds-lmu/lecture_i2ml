...
% TODO verallgemeinern mit set-based metric $\rho$
% BITTE PRüFEN
\begin{algorithm}[H]
\scriptsize
...
E.g. average increase of MSE for predictions of OOB observations after permuting the $j$-th feature of mtcars:

\vspace{-1em}
\begin{center}
%TODO Schriftgröße
\includegraphics[width=0.7\textwidth]{figure/forest-fimp_perm.png}
\end{center}
...
% TODO hier wollte Bernd noch eine summary schreiben
