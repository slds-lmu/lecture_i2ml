...
\only<1>{\includegraphics[width=350pt]{figure_man/forest-missing-value_1.png}}
\only<2>{\includegraphics[width=350pt]{figure_man/forest-missing-value_2.png}}
\only<3>{\includegraphics[width=350pt]{figure_man/forest-missing-value_3.png}}
\end{center}
\begin{enumerate}
