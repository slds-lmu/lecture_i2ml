...
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  $\textcolor{orange}{\I(i \in \text{OOB}^{[1]}) = 1}$
\end{minipage}
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  $\textcolor{orange}{\I(i \in \text{OOB}^{[2]}) = 0}$
\end{minipage}
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  $\textcolor{orange}{\I(i \in \text{OOB}^{[3]}) = 1}$
\end{minipage}
\begin{minipage}{0.7\textwidth}
  % https://docs.google.com/drawings/d/1Lfc7lRDgtrkwHDRlJahDNYtOoQ7biBJQkGGTjMDkeaM/edit
  \includegraphics[width = 0.95\textwidth]{figure_man/forests-oob-pred.jpg}
\end{minipage}%
\begin{minipage}{0.3\textwidth}
  \tiny
  $\yih_{\text{OOB}} = $ \\ 
  $= \frac{1}{\textcolor{orange}{S_{\text{OOB}}^{(i)}}} 
  \sum_{m} \I(i \in \text{OOB}^{[m]}) \textcolor{blue}{\hat{y}^{(i)[m]}}$ \\
  $= \frac{1}{\textcolor{orange}{2}} (\textcolor{blue}{5 + 8}) = 6.5$
\end{minipage}
\vspace{-0.2cm}
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  $\textcolor{blue}{\hat{y}^{(i)[1]} = 5}$
\end{minipage}
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  \phantom{foo}
...
\begin{minipage}[b]{0.19\textwidth}
  \tiny
  $\textcolor{blue}{\hat{y}^{(i)[1]} = 8}$
\end{minipage}

\vspace{0.2cm}
\tiny
% $\yih_{\text{OOB}} =  \frac{1}{\textcolor{orange}{S_{\text{OOB}}^{(i)}}} 
% \sum_{m} \I(i \in \text{OOB}^{[m]}) \textcolor{blue}{\hat{y}^{(i)[m]}}
% = \frac{1}{\textcolor{orange}{2}} (\textcolor{blue}{5 + 8}) = 6.5$
