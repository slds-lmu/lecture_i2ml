...
%! includes: performance-resampling
...
\includegraphics[width=0.6\textwidth]{figure_man/autotune_in_model_fit.png}
\end{center}
\end{vbframe}
...
\includegraphics[width=0.6\textwidth]{figure_man/train_valid_test.png}
\end{center}
...
% FIGURE SOURCE: https://drive.google.com/open?id=1Us-zxKUQtppoFTbogn7KjYae8VCPXn1F
\includegraphics[width=1\textwidth]{figure_man/train_valid_test.png}
\column{0.45\textwidth}
% FIGURE SOURCE: https://drive.google.com/open?id=1vKksRNOzK_iwnYBEBu9iHCUICFUM3f0Y
\includegraphics[width=1\textwidth]{figure_man/autotune_in_model_fit.png}
\end{columns}
\end{vbframe}
