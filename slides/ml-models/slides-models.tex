...
\begin{columns}[onlytextwidth]
  \begin{column}{0.5\textwidth}
    ...
    \footnotesize
    \begin{itemize}
      \positem \textbf{high accuaracy}
      \positem \textbf{compact solutions} (often sparse solution)
