...
\begin{frame}{$k$-NN -- Functionality}
...
\highlight{Hyperparameters} ~~ $k$, i.e., \textbf{neighborhood size} \\

\medskip

% \highlight{Runtime behavior} ~~ $\mathcal{O}(oh)$
...
\highlight{Implementation}
\begin{itemize}
  \item \textbf{R:} \code{mlr3} learners \code{Learner} , calling \code{XX}
  \item \textbf{Python:} \code{XX} from package \code{scikit-learn}
\end{itemize}
...
\begin{minipage}{0.5\textwidth}
  \includegraphics[width=\textwidth]{figure/cart_treegrow_3}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
  \includegraphics[width=\textwidth]{figure/cart_treegrow_32}
\end{minipage}
\begin{minipage}{0.5\textwidth}
  \tiny Axis-aligned input space partition for \code{iris} data 
  \textcolor{blue}{FIG SIZE}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
  \tiny Corresponding classification tree \textcolor{blue}{FIG SIZE}
\end{minipage}
...
\begin{minipage}{0.5\textwidth}
  ...
  \includegraphics[width=0.8\textwidth]{figure/cart_forest_intro_1.pdf}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
  \includegraphics[width=0.8\textwidth]{figure/cart_forest_intro_3.pdf}
\end{minipage}
\begin{minipage}{0.5\textwidth}
  \tiny Input space partition for 10-tree ensemble \textcolor{blue}{FIG SIZE}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
  \tiny Input space partition for 500-tree ensemble \textcolor{blue}{FIG SIZE}
\end{minipage}
...
\end{minipage}
\begin{minipage}{0.5\textwidth}
  \tiny Gradient boosting for univariate function \textcolor{blue}{FIG SIZE}
\end{minipage}%
\begin{minipage}{0.5\textwidth}
  \tiny Gradient boosting for bivariate function \textcolor{blue}{FIG SIZE}
\end{minipage}
...
\begin{minipage}{0.67\textwidth}
  \tiny Classification of \code{spirals} data with XX layer-network
\end{minipage}%
\begin{minipage}{0.33\textwidth}
  \tiny Classification error vs epochs
\end{minipage}
