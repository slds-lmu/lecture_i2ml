...
\begin{minipage}[b]{0.24\textwidth}
  \begin{center}
    % TODO graphics does not exist
     %\includegraphics[width=0.7\textwidth, trim=0 40 0 0, clip]{.../supervised-classification/figure/reg_class_loss_1}\\
...
\begin{vbframe}{CART -- Implementation \& Practical hints}
  \footnotesize
...
\begin{vbframe}{Gradient Boosting -- Practical hints}
  \footnotesize
...
\begin{vbframe}{nonlinear SVM -- Implementation \& Practical hints}
