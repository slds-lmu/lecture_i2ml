...
\textcolor{blue}{Mini benchmark study for 3 classifiers (e.g., on iris), then 
evaluation on different metrics -- message: different metrics might lead to 
different best classifiers (inspo: chapter 3.3. in Japkowicz/Shah (2011)}
