...
We simulate overfitting using datasets generated from $mlbench.peak$ (in $mlbench$ library) and multiple ML hypothesis spaces with varying complexity.
\vspace{0.5cm}
...
Observations:
\begin{itemize}
	\item As the dimensionality of the feature space $p$ increases, generalization error and overfitting also increase.
	\item As the amount of training data $n$ increases, generalization error and overfitting decreases.
	\item As $p$ increases, the hypothesis space needs to be complex enough to minimize generalization error and overfitting.
