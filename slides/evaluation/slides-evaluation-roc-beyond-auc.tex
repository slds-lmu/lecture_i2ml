...
&= (FNR - FPR) \cdot \rp + FPR
\end{align*}
Similarly, misclassification costs can also be written as a function of $\rp$:
...
\begin{itemize}
\itemsep0em
\item $Costs_{norm}$ (normalized misclassification costs) is a natural extension of the error rate.
