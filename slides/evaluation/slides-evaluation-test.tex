...
\item We observe the train and test error when we change the size of training set, the size of the test set and the model complexity (increasing the possible degrees of the polynomials). 
\end{itemize}
