...
\item Learn about countermeasures to overfitting}
...
We can quantify overfitting as difference between the generalization error and the apparent training error, i.e.
$$\GEfull - \rho(\yv_{\mathrm{train}}, F_{\textrm{train}}).$$
We can estimate this quantity via e.g. a holdout-split 
$$\GEh_{\Dtrain, \Dtest}(\inducer,
  \lamv, \ntrain, \rho) - \rho(\yv_{\mathrm{train}}, F_{\textrm{train}}).$$
