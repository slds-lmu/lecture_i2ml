...
\begin{itemize}
  ...
  \end{center}
  \item The AUC abstracts from the actual classification scores,
  considering only their rank.
\end{itemize}

\framebreak 

\begin{itemize}
  \item We can thus interpret the AUC as the probability of our classifier 
...
\includegraphics[width=0.9\textwidth,page=1]{figure_man/auc_interpretation_new}
\end{center}
...
\begin{itemize}
  \item The Mann-Whitney-U test is a non-parametric hypothesis test on 
  differences in location between two distributions.
\end{itemize}
...
\begin{itemize}
\item Now, we will see how the AUC relates to the (normalized) 
