...
\item Let $\text{AUC}(k ~|~ \ell)$ be the probability that a randomly drawn member of class $k$ has a lower probability of belonging to class $\ell$ than a randomly drawn member of class $\ell$ (which is a related interpretation of the AUC).
