...
\begin{itemize}
  ...
  binary-class case.
  \item We can easily extend AUC to multi-class classification, where the 
  classifier predicts the probability $\postk$ of belonging to class $k$ for 
  each class $k \in \setg$, $g > 2$.
