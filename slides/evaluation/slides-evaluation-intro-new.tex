...
\includegraphics[width=0.7\textwidth]{figure_man/evaluation-intro-ge.pdf}
\end{center}
...
\begin{itemize}
  ...
  train-test split:
  $$\widehat{\mathrm{GE}}_{J_\mathrm{train}, J_\mathrm{test}}(\inducer,
  \lambdav, m_\mathrm{train}, \rho) =
  \rho(\yv_{J_\mathrm{test}}, \bm{F}_{J_\mathrm{test}, 
...
\begin{itemize}
  ...
  \item On the other hand, we sometimes use losses that are 
...
\begin{itemize}
  ...
  $\rightarrow$ We may evaluate our learner on its \textbf{MCE}. 
\end{itemize}
