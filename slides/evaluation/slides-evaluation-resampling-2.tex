...
\bibinput{slides-evaluation-resampling-2}
...
\item Worse: there is no unbiased estimator of $\mathbb{V}[\GEh]$ \citepurl{bengio2004}
...
\bibliography{slides-evaluation-resampling-2}
