...
df <- readRDS("overfitting_peak_boost_10rounds.rds")
...
# ggsave(filename = "../figure/visualize_overfitting_plot_peak_boost_10rounds.png", plot=p, width=21, height=9)

tmp <- df[df$learner_id == "Linear Model",]