...
@
\lecturechapter{Evaluation: Measures for Binary Classification: ROC Measures and ROC curve}
...
Remember: Both scoring and probabilistic classifiers can output classes by thresholding.\\
