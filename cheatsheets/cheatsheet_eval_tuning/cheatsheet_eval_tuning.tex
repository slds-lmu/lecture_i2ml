...
\textbf{Tuner} $\tau$ is a mapping which takes a dataset $\D \in \allDatasets$, a inducer $\ind$, a search space $\LamS$, a performance strategy $\rho$ and a resampling strategy $\mathcal{J}$ and 
