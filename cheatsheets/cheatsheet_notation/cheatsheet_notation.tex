...
%						    from data
%						\end{codebox}
						\hspace*{1ex}We might suppress $\bm{\theta}$ in notation.
						...
						\begin{codebox}
							$\bm{\theta} \in \Theta$ : model \textbf{parameters}
						\end{codebox}
						...
						\begin{codebox}
						$\LLt$ and $\llt$ : Likelihood and log-Likelihood for a parameter $\bm{\theta}$
						\end{codebox}
