...
$\hx: \textcolor{blue}{\R^g} \rightarrow \Yspace$ : \textbf{prediction function} for classification that maps class scores / posterior probabilities to discrete classes \\
