% basic latex stuff
\newcommand{\pkg}[1]{{\fontseries{b}\selectfont #1}} % fontstyle for R packages, used exactly once in forests/slides-forests-benchmark.tex
...
% %--------------------------------------------%
% %  Citebutton  -- moved to lmu-lecture.sty ! %
% %--------------------------------------------%
