...
we train on the data 1:30 and test on 31:50. Remember, that iris is an ordered data set with the first 50 observations being setosa, the next 50 versicolor and the last 50 virginica. 
...
The problem lies therein that we never showed the learner training data with the
