...
\begin{vbframe}{Training set vs Test Set}
  ...
  \item But what if our train/test split isn’t random? What if one subset of our data
    has only people from a certain category or is constant in one of the features?
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% BOTH RCOURSES AND ORIGINAL follows %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
