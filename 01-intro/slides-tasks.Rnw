...
\begin{itemize}
  ...
  \item \textbf{Medicine:} Calculating the life expectancy for patients with a particular disease and severity
...
\begin{itemize}
  ...
  \item \textbf{Software:} Detecting whether an e-mail is spam or not using its content
  \item \textbf{Lie Detection:} Predicting future income of a person based on education and skills
\end{itemize}
...
\begin{center}
  \includegraphics[width=0.78\textwidth]{figure_man/lie-detector-polygraph.jpg}
\end{center}
