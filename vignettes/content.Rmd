...
- Slot 1:
    * Hyperparameter Tuning [[pdf](https://github.com/compstat-lmu/lecture_i2ml/blob/master/slides-pdf/slides-tuning.pdf)|[video](https://youtu.be/5F5wBZ-WjI8)]
- Slot 2:
    * Nested Resampling [[pdf](https://github.com/compstat-lmu/lecture_i2ml/blob/master/slides-pdf/slides-nested-resampling.pdf)|[video](https://youtu.be/aV__yAFzNtc)]
