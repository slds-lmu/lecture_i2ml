...
qda.data.test$pred.true = ifelse(pred.test$data$truth == pred.test$data$response, "true", "false")
qda.data.train$pred.true = ifelse(pred.train$data$truth == pred.train$data$response, "true", "false")
