...
\small
\begin{tabular}{cc|cc}
    & & \multicolumn{2}{c}{\bfseries Actual/True Class $\mathbf{y}$} \\
    & & $+$ & $-$ \\
    \hline
    \multirow{2}{*}{\parbox{2cm}{ \centering \bfseries Prediction \^{y}}} & $+$ & \bfseries True Positive (TP) & \textbf{False Positive (FP)} \\
...
\begin{tabular}{cc|cc|c}
    ...
    & & $+$ & $-$ & \\
    \hline
    \multirow{4}{*}{\parbox{1.2cm}{ \centering \bfseries Prediction \^{y}}} & \multirow{2}{*}{$+$} & \multirow{2}{*}{\bfseries True Positive (TP)} & \multirow{2}{*}{\textbf{False Positive (FP)}} & Positive Predictive\\
...
\begin{tabular}{cc|cc|c}
    ...
    & & $+$ & $-$ & \\
    \hline
    \multirow{4}{*}{\parbox{1.2cm}{ \centering \bfseries Prediction \\ \^{y}}} & \multirow{2}{*}{$+$} & \bfseries True Positive (TP) & \textbf{False Positive (FP)} & \multirow{2}{*}{PPV = $\frac{20}{200} = 0.1$}\\
    & & TP = $20$ & FP = $180$ & \\
