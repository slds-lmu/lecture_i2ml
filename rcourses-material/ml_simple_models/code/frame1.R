...
points.3d = trans3d(x = 0.2, y = 2, z = sse1, pmat = p)
points(points.3d, col = colBlue(255), pch = 16, cex = 2)
...
plot(x = 0, y = 0, axes = FALSE, col = "white", xlab = "yvalue", ylab = "xvalue", col.lab = "white")
