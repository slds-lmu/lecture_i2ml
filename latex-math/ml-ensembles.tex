...
\newcommand{\blhs}{\hat{f}^{[m]}} % estimated baselearner: scores
\newcommand{\blhsx}{\blhs(\xv)} % estimated baselearner: scores of x
\newcommand{\blhl}{\hat{h}^{[m]}} % estimated baselearner: hard labels
\newcommand{\blhlx}{\blhl(\xv)} % estimated baselearner: hard labels of x
\newcommand{\blhp}{\hat \pi^{[m]}} % estimated baselearner: probabilities
\newcommand{\blhpxk}{\hat \pi_{k}^{[m]}(\xv)} % estimated baselearner: probabilities of x for class k
